...
class Blog extends CI_Controller {
    ...
    function index($start = 0)//index page
    {
        ...
        $class_name = array('main_class' => '', 'home_class' => 'current', 'login_class' => '', 'register_class' => '', 'upload_class' => '', 'contact_class' => '');
    ...
    function post($post_id)//single post page
    {
        ...
        $class_name = ['main_class' => '', 'home_class' => 'current', 'login_class' => '', 'register_class' => '', 'upload_class' => '', 'contact_class' => ''];
        $this->load->view('header', $class_name);
